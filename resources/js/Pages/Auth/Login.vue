            ...
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        <p class="text-black m-0 font-semibold uppercase">Paquetería</p>
                        <svg width="85" height="85" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"
                        class="w-24 shrink-0 mx-auto">
                        ...
                        <p class="text-black font-semibold uppercase">Casa Blanca</p>
