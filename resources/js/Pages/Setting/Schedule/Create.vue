            ...
            <form @submit.prevent="submit">
                <div class="bg-white dark:bg-neutral-900 shadow-md rounded-lg p-6">
                    ...
                    <div v-if="selectedBranchesSchedules.length"
                        ...
                        <h3
                            class="font-semibold mb-3 bg-[#f8f8f8] dark:bg-neutral-700 text-[#3f3f3f] dark:text-gray-300 text-lg rounded-md px-2">
                    ...
                    <div>
                        ...
                        <div class="border rounded-lg p-4 space-y-4">
                            <div class="grid grid-cols-6 gap-3 font-semibold text-sm">
                                ...
                                <span>Total Hrs</span>
                                <span class="text-center">Día laborable</span>
                            </div>
